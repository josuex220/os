    ...
    <div class="app-wrapper">
		...
		<?php $this->load->view('includes/alerts')?>
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Lista de Impressora / <?=$route?></h1>
				    </div>
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" action="<?=current_url()?>" method="POST">
									<div class="mb-3">
									    ...
									    <input type="text" class="form-control" id="setting-name" <?= $formDisabled ? 'disabled' : '' ?> name="marca" value="<?=$user['marca']?>" placeholder="Ex: HP" required="">
									</div>
								    <div class="mb-3">
									    <label for="setting-modelo" class="form-label">Modelo</label>
									    <input type="text" class="form-control" id="setting-modelo" <?= $formDisabled ? 'disabled' : '' ?> name="modelo" value="<?=$user['modelo']?>" required placeholder="Ex: Deskjet">
									</div>
								    <div class="mb-3">
									    <label for="setting-serie" class="form-label">Serie</label>
									    <input type="text" class="form-control" id="setting-serie" <?= $formDisabled ? 'disabled' : '' ?> name="serie" value="<?=$user['serie']?>" placeholder="Ex: Serie 1">
									</div>
								    <div class="mb-3">
