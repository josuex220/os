<?php $this->load->view('includes/header')?>
	...
	<?php $this->load->view('includes/alerts')?>
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Lista de Equipamentos</h1>
				    </div>
				    <div class="col-auto">
						    ...
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    <div class="col-auto">
								    <form class="table-search-form row gx-1 align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a class="btn app-btn-primary" href="/equipamento/add">Adicionar Novo</a>
                                        </div>
					                </form>
										...
										<tbody>
                                            <?php if($equipamentos['all']){ 
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cell">
                                                        <a class="btn-sm app-btn-secondary" href="/equipamento/ver/<?=$equipamento->id_equipamento?>">Ver</a>
														<?php if($this->session->userdata('roles') == "ADMIN"){ ?>
															<a class="btn-sm app-btn-secondary" href="/equipamento/editar/<?=$equipamento->id_equipamento?>">Editar</a>
															<a class="btn-sm app-btn-secondary btn-deletar" href="/equipamento/deletar/<?=$equipamento->id_equipamento?>">Apagar</a>
														<?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } } else{ ?>
